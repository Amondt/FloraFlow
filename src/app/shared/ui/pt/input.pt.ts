...
export const FloraInputNumberPT = {
  root: {
    class:
      'w-full flex rounded-garden-sm overflow-hidden border border-neutral-300 dark:border-neutral-600',
  },
  pcInputText: {
    root: {
      class: [
  ...
  incrementButton: {
    class:
      'flex flex-1 items-center justify-center px-2 bg-neutral-100 dark:bg-neutral-700 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-600 transition-colors duration-150',
  },
  decrementButton: {
    class:
      'flex flex-1 items-center justify-center px-2 bg-neutral-100 dark:bg-neutral-700 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-600 transition-colors duration-150 border-t border-neutral-300 dark:border-neutral-600',
  },
