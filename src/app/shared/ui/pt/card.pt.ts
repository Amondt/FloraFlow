...
export const FloraCardPT = {
  root: {
    class:
      'bg-white dark:bg-neutral-800 border border-neutral-200/60 dark:border-neutral-700/50 rounded-garden-md p-5 shadow-sm transition-all duration-200 hover:shadow-md',
  },
  title: {
