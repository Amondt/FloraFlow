...
- [ ] **Block A — `SpeciesGroup` type + `groupBotanicalRecords()` utility** | Agent: `/visualizer`
...
- [ ] **Block B — LibraryComponent: groupedResults + reactive dialog binding** | Agent: `/visualizer`
...
- [ ] **Block C — BotanicalRecordCardComponent: variety count badge** | Agent: `/visualizer`
...
- [ ] **Block D — BotanicalDetailDialogComponent: records input + cultivar picker** | Agent: `/visualizer`
