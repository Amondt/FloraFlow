...
export const FloraCardPT = {
  root: {
    class:
      'bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700/60 rounded-garden-md p-5 shadow-sm transition-all duration-200 hover:shadow-md',
  },
  title: {
    class: 'text-lg font-medium font-display text-neutral-900 dark:text-white mb-2',
  },
  subtitle: {
