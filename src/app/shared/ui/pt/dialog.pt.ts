...
export const FloraDialogPT = {
  ...
  pcCloseButton: {
    root: { class: 'p-1 rounded hover:bg-primary-700 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-white' },
  },
  content: {
...
export const FloraConfirmDialogPT = {
  root: {
    root: { class: 'max-w-sm w-full bg-white dark:bg-neutral-900 rounded-garden-lg shadow-2xl overflow-hidden border border-neutral-100 dark:border-neutral-700' },
  },
  header: {
