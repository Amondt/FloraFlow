...
CREATE POLICY "Users can upload their own journal images" ON storage.objects FOR INSERT TO authenticated
WITH
  CHECK (
...
CREATE POLICY "Users can read their own journal images" ON storage.objects FOR
SELECT
