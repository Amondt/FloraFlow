...
export const FloraPanelPT = {
  root: {
    class:
      'bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-garden-md overflow-hidden',
  },
  header: {
    class:
  ...
  pcToggleButton: {
    root: {
      class: `p-1 rounded text-neutral-500 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors ${FLORA_FOCUS}`,
    },
  },
